...
```json
{
    ...
    "rust-analyzer.cargo.extraEnv": {
        ...
        "PYO3_PYTHON": "/home/one/.local/share/uv/python/cpython-3.12.11-linux-x86_64-gnu/bin/python3",
        "LD_LIBRARY_PATH": "/home/one/.local/share/uv/python/cpython-3.12.11-linux-x86_64-gnu/lib",
    },
}
```
...
```shell
LD_LIBRARY_PATH=~/.local/share/uv/python/cpython-3.12.11-linux-x86_64-gnu/lib:$LD_LIBRARY_PATH \
