...
# 删除缓存
rm -rf target/debug/build/llama-cpp-sys-2-*
rm -rf target/debug/.fingerprint/llama-cpp-sys-2-*
...
rm -rf target/x86_64-unknown-linux-gnu/debug/.fingerprint/llama-cpp-sys-2-*
rm -rf target/x86_64-unknown-linux-gnu/release/build/llama-cpp-sys-2-*
rm -rf target/x86_64-unknown-linux-gnu/release/.fingerprint/llama-cpp-sys-2-*
