...
impl LlamaCppChat {
    ...
    #[pyo3(name = "execute", signature = (model_path, system_prompt, user_prompt, n_ctx, n_predict, seed,disable_gpu, main_gpu, n_gpu_layers, keep_context, cache_model, extra_options=None))]
    fn execute<'py>(
        &mut self,
        py: Python<'py>,
        model_path: String,
...
impl LlamaCppChat {
    ...
    fn options_parser<'py>(
        ...
        options.context_history_cache_key = "context_history_llama_cpp_chat_cache_key".to_string();
